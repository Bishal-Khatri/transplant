<template>
    <div>
        <!--<div class="modal fade" id="create-order-dialog" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">-->
            <!--<div class="modal-dialog modal-lg modal-dialog-centered">-->
                <!--<div class="modal-content">-->
                    <!--<div class="modal-header text-center">-->
                        <!--<h4 class="modal-title">Add Quantity on </h4>-->
                        <!--<div class="small"><i class="fa fa-clock-o"></i> Created </div>-->
                    <!--</div>-->
                                    ...
                                    <!--<div class="panel-body">-->
                                        <!--<form class="form-group">-->
                                            <!--<div class="form-group row">-->
                                                <!--<label for="quantity" class="col-sm-2 col-form-label">Payment Method <span style="font-size: 18px" class="text-danger">*</span></label>-->
                                                <!--<div class="col-sm-10">-->
                                                    <!--<select class="form-control" v-model="payment_method">-->
                                                        <!--<option value="cod">Cash On Delivery</option>-->
                                                    <!--</select>-->
                                                    <!--<span class="form-text small text-danger" v-html="errors.get('payment_method')"></span>-->
                                                <!--</div>-->
                                            <!--</div>-->
                                            <!--<div class="form-group row">-->
                                                <!--<label for="purchase_date" class="col-sm-2 col-form-label">Local Address</label>-->
                                                <!--<div class="col-sm-10">-->
                                                    <!--<input type="date" v-model="local_address" class="form-control" id="local_address" placeholder="Local Address" >-->
                                                <!--</div>-->
                                            <!--</div>-->
                                            <!--<div class="form-group row">-->
...
<script>
    ...
    export default {
        ...
        methods: {
            openDialog(subscriber) {
                this.subscriber = subscriber;
                $("#create-order-dialog").modal("show");
            },
            async saveOrder() {
